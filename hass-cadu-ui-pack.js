var B=["entity","name","image","velocidade","altitude","condition"];function q(s){if(!s||typeof s!="object"||Array.isArray(s))return{entity:"",name:"",image:"",image_rotated:"",velocidade:"",altitude:"",condition:"",rastro:!1,rastro_duracao_min:null,rastro_pontos_por_min:null,rastro_cor:"",rastro_max_pontos:null};try{let t=Object.keys(s).filter(e=>/^\d+$/.test(e)),o={entity:s.entity||"",name:s.name||"",image:s.image||"",image_rotated:s.image_rotated||"",velocidade:s.velocidade||"",altitude:s.altitude||"",condition:s.condition||"",rastro:s.rastro===!0,rastro_duracao_min:typeof s.rastro_duracao_min=="number"?s.rastro_duracao_min:null,rastro_pontos_por_min:typeof s.rastro_pontos_por_min=="number"?s.rastro_pontos_por_min:null,rastro_cor:s.rastro_cor||"",rastro_max_pontos:typeof s.rastro_max_pontos=="number"?s.rastro_max_pontos:null};return Object.keys(s).forEach(e=>{!/^\d+$/.test(e)&&o[e]===void 0&&(o[e]=s[e])}),t.length>0&&t.forEach(e=>{let i=Number(e);if(isNaN(i)||i<0||i>=B.length)return;let r=B[i];r&&o[r]===""&&s[e]&&(o[r]=s[e])}),o}catch(t){return console.error("Erro ao normalizar entidade:",t,s),{entity:s.entity||"",name:s.name||"",image:s.image||"",image_rotated:s.image_rotated||"",velocidade:s.velocidade||"",altitude:s.altitude||"",condition:s.condition||"",rastro:s.rastro===!0,rastro_duracao_min:typeof s.rastro_duracao_min=="number"?s.rastro_duracao_min:null,rastro_pontos_por_min:typeof s.rastro_pontos_por_min=="number"?s.rastro_pontos_por_min:null,rastro_cor:s.rastro_cor||"",rastro_max_pontos:typeof s.rastro_max_pontos=="number"?s.rastro_max_pontos:null,...s}}}function A(s){return Array.isArray(s)?s.filter(t=>t&&typeof t=="object").map(t=>{try{return q(t)}catch(o){return console.error("Erro ao normalizar entidade:",o,t),t}}):[]}var T=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._styleElement=document.createElement("style"),this.shadowRoot.appendChild(this._styleElement),this.controlsContainer=document.createElement("div"),this.controlsContainer.className="map-controls",this.shadowRoot.appendChild(this.controlsContainer),this.mapContainer=document.createElement("div"),this.mapContainer.id="map",this.shadowRoot.appendChild(this.mapContainer),this.followCountdownElement=document.createElement("div"),this.followCountdownElement.className="follow-countdown",this.followCountdownElement.title="Clique para retomar o seguir";let t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.setAttribute("class","follow-countdown-circle"),t.setAttribute("viewBox","0 0 44 44");let o=document.createElementNS("http://www.w3.org/2000/svg","circle");o.setAttribute("class","follow-countdown-bg"),o.setAttribute("cx","22"),o.setAttribute("cy","22"),o.setAttribute("r","19"),t.appendChild(o),this.followCountdownProgressCircle=document.createElementNS("http://www.w3.org/2000/svg","circle"),this.followCountdownProgressCircle.setAttribute("class","follow-countdown-progress"),this.followCountdownProgressCircle.setAttribute("cx","22"),this.followCountdownProgressCircle.setAttribute("cy","22"),this.followCountdownProgressCircle.setAttribute("r","19");let e=2*Math.PI*19;this.followCountdownProgressCircle.setAttribute("stroke-dasharray",e),this.followCountdownProgressCircle.setAttribute("stroke-dashoffset",e),t.appendChild(this.followCountdownProgressCircle),this.followCountdownElement.appendChild(t);let i=document.createElementNS("http://www.w3.org/2000/svg","svg");i.setAttribute("class","follow-countdown-icon"),i.setAttribute("viewBox","0 0 24 24"),i.setAttribute("width","18"),i.setAttribute("height","18");let r=document.createElementNS("http://www.w3.org/2000/svg","path");r.setAttribute("d","M12 2v4m0 12v4M2 12h4m12 0h4M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z"),r.setAttribute("stroke","white"),r.setAttribute("stroke-width","2"),r.setAttribute("stroke-linecap","round"),r.setAttribute("fill","none"),i.appendChild(r),this.followCountdownElement.appendChild(i),this.followCountdownElement.addEventListener("click",()=>{this._resumeFollowImmediately()}),this.shadowRoot.appendChild(this.followCountdownElement),this.markers={},this.infoBoxes={},this.lastPositions={},this.trails={},this.trailPolylines={},this._lastMapTypeOptions=null,this._lastMapControlsOptions=null,this._historyLoaded={},this._uiState={trafficEnabled:!1,nightModeEnabled:!1,followEnabled:!1,trafficOverride:!1,nightModeOverride:!1,followOverride:!1,rotateImageEnabled:!1,arrowEnabled:!0,entityVisibility:{}},this._followPausedByUser=!1,this._followResumeTimer=null,this._followResumeTime=null,this._followCountdownInterval=null,this._isPerformingProgrammaticMove=!1,this._lastProgrammaticMoveTime=null,this._optionsMenuOpen=!1,this._updateStyles()}_updateStyles(){var m,h,_,c;let t=((m=this._config)==null?void 0:m.max_height)||null,o=((h=this._config)==null?void 0:h.max_width)||null,e="450px",i="600px",r=t?`${t}px`:e,a=t?`${t}px`:i,n=o?`max-width: ${o}px;`:"",l=((_=this._config)==null?void 0:_.mostrar_menu)!==!1,d=((c=this._config)==null?void 0:c.ocultar_creditos)===!0;this._styleElement.textContent=`
    ...
    `;let e=document.createElement("ha-card"),i=document.createElement("div");i.className="picture-wrapper",i.style.setProperty("--po-aspect-ratio",String(t)),i.style.setProperty("--po-fit-mode",o),i.addEventListener("click",()=>{var c;this._handleAction((c=this._config)==null?void 0:c.tap_action,this._getPrimaryEntityId())});let r=document.createElement("div");r.className="picture-spacer",i.appendChild(r);let a=document.createElement("img");a.className="picture-image",a.alt=((_=this._config)==null?void 0:_.title)||"Imagem",a.loading="eager",a.decoding="async",i.appendChild(a);let n=document.createElement("div");n.className="picture-placeholder",n.textContent="Configure image ou image_entity",n.style.display="none",i.appendChild(n);let l=document.createElement("div");l.className="overlay-top",i.appendChild(l);let d=document.createElement("div");d.className="overlay",i.appendChild(d),e.appendChild(i),this.shadowRoot.appendChild(e),this._elements={card:e,pictureWrapper:i,img:a,placeholder:n,overlayTop:l,overlay:d},this._rendered=!0,this._updateCard()}_updateCard(){var d,m;if(!this._rendered||!this._elements)return;let{img:t,placeholder:o,overlayTop:e,overlay:i}=this._elements,r=this._getImageUrl(),a=!!((d=this._config)!=null&&d.image_entity),n=((m=this._config)==null?void 0:m.image_entity)||"",l=(r||"")!==(t.src||"");if(a&&!r){let h=this._getImageEntityCache(n);h?(t.src=h,t.style.display="block",o.style.display="none"):(t.src="",t.style.display="none",o.textContent="Carregando imagem\u2026",o.style.display="flex")}else if(l)if(r){let h=t.src&&t.complete&&t.naturalWidth>0,_=a?this._getImageEntityCache(n):null,c=()=>a&&this._saveImageEntityCache(n,r),u=()=>{t.style.display="block",o.style.display="none",c()};if(a&&_)if(t.onload=null,t.onerror=null,t.src=_,t.style.display="block",o.style.display="none",_!==r&&this._pendingImageUrl!==r){this._pendingImageUrl=r;let p=new Image;p.onload=()=>{var f;this._pendingImageUrl===r&&((f=this._elements)!=null&&f.img)&&(this._elements.img.src=r,u()),this._pendingImageUrl=null},p.onerror=()=>{this._pendingImageUrl=null},p.src=r}else _===r&&(t.complete&&t.naturalWidth?c():t.onload=c);else if(a&&h&&this._pendingImageUrl!==r){this._pendingImageUrl=r;let p=new Image;p.onload=()=>{var f;this._pendingImageUrl===r&&((f=this._elements)!=null&&f.img)&&(this._elements.img.src=r,u()),this._pendingImageUrl=null},p.onerror=()=>{this._pendingImageUrl=null},p.src=r}else a&&h||(t.onload=null,t.onerror=null,a?(o.textContent="Carregando imagem\u2026",o.style.display="flex",t.style.display="none",t.onload=()=>{o.style.display="none",t.style.display="block",c()},t.onerror=()=>{o.textContent="Erro ao carregar imagem",o.style.display="flex",t.style.display="none"}):(o.style.display="none",t.style.display="block"),t.src=r,a&&t.complete&&t.naturalWidth&&(o.style.display="none",t.style.display="block",c()))}else this._pendingImageUrl=null,t.src="",t.style.display="none",o.textContent="Configure image ou image_entity",o.style.display="flex";this._updateOverlayTop(e),this._updateOverlayBottom(i)}_isEntityVisible(t){let o=t==null?void 0:t.show_condition;if(!o||typeof o!="string"||o.trim()==="")return!0;let e=this._renderTemplate(o),i=String(e).trim().toLowerCase();return!(i===""||i==="false"||i==="no"||i==="0")}_updateOverlayTop(t){let e=this._getOverlayEntityConfigs().filter(i=>(i.position||"bottom")==="top").filter(i=>this._isEntityVisible(i));t.innerHTML="",e.length!==0&&e.forEach(i=>{let r=document.createElement("div");r.className="overlay-entity";let a=i.background_color||"rgba(255, 255, 255, 0.25)",n=i.background_color_opacity!=null?$(a,i.background_color_opacity):a,l=i.text_color||"#fff";r.style.background=n,r.style.color=l;let d=Number(i.border_width);d>0&&(r.style.borderWidth=`${d}px`,r.style.borderStyle="solid",r.style.borderColor=i.border_color||"rgba(255,255,255,0.5)"),r.addEventListener("click",_=>{var u;_.stopPropagation();let c=i.tap_action||((u=this._config)==null?void 0:u.tap_action);this._handleAction(c,i.entity)});let m=this._createEntityIcon(i);r.appendChild(m);let h=document.createElement("div");h.textContent=this._getEntityState(i.entity,i),r.appendChild(h),t.appendChild(r)})}_updateOverlayBottom(t){var l,d,m,h;let o=((l=this._config)==null?void 0:l.title)||"",e=((d=this._config)==null?void 0:d.title_secondary)||"",i=this._renderTemplate(((m=this._config)==null?void 0:m.subtitle)||""),r=((h=this._config)==null?void 0:h.title_icon)||"",n=this._getOverlayEntityConfigs().filter(_=>(_.position||"bottom")==="bottom").filter(_=>this._isEntityVisible(_));if(t.innerHTML="",t.style.display=o||i||n.length>0?"flex":"none",o||i){let _=document.createElement("div");if(_.className="overlay-title-container",o){let c=document.createElement("div");if(c.className="overlay-title",r){let p=document.createElement("ha-icon");p.icon=r,c.appendChild(p)}let u=document.createElement("span");if(u.textContent=o,c.appendChild(u),e){let p=document.createElement("span");p.className="overlay-title-secondary",p.textContent=e,c.appendChild(p)}_.appendChild(c)}if(i){let c=document.createElement("div");c.className="overlay-subtitle",c.textContent=i,r?c.style.paddingLeft="24px":c.style.paddingLeft="0",_.appendChild(c)}t.appendChild(_)}else{let _=document.createElement("div");_.style.flex="1",t.appendChild(_)}if(n.length>0){let _=document.createElement("div");_.className="overlay-entities",n.forEach(c=>{let u=document.createElement("div");u.className="overlay-entity";let p=c.background_color||"rgba(255, 255, 255, 0.25)",f=c.background_color_opacity!=null?$(p,c.background_color_opacity):p,w=c.text_color||"#fff";u.style.background=f,u.style.color=w;let b=Number(c.border_width);b>0&&(u.style.borderWidth=`${b}px`,u.style.borderStyle="solid",u.style.borderColor=c.border_color||"rgba(255,255,255,0.5)"),u.addEventListener("click",y=>{var M;y.stopPropagation();let x=c.tap_action||((M=this._config)==null?void 0:M.tap_action);this._handleAction(x,c.entity)});let E=this._createEntityIcon(c);u.appendChild(E);let g=document.createElement("div");g.textContent=this._getEntityState(c.entity,c),u.appendChild(g),_.appendChild(u)}),t.appendChild(_)}}_renderTemplate(t){if(!t||typeof t!="string")return"";if(!t.includes("{%")&&!t.includes("{{"))return t;try{if(!this._hass||!this._hass.connection)return"";let o=Date.now(),e=this._templateCache.get(t);if(e&&o-e.ts<1e3)return e.value;if(!this._templateRequests.has(t)){let i=this._hass.connection.subscribeMessage(r=>{let a=(r==null?void 0:r.result)||"";this._templateCache.set(t,{value:String(a),ts:Date.now()}),this._templateRequests.delete(t),i&&i(),requestAnimationFrame(()=>this._updateCard())},{type:"render_template",template:t});this._templateRequests.set(t,i)}return e?e.value:""}catch(o){return console.warn("Erro ao renderizar template:",o),""}}_parseAspectRatio(t){if(!t||typeof t!="string")return 1.5;let o=t.trim();if(o.includes(":")){let[i,r]=o.split(":").map(a=>Number(a));if(Number.isFinite(i)&&Number.isFinite(r)&&i>0&&r>0)return i/r}let e=Number(o);return Number.isFinite(e)&&e>0?e:1.5}_getImageUrl(){var o,e,i,r,a,n;let t="";if((o=this._config)!=null&&o.image)typeof this._config.image=="string"?t=this._config.image:typeof this._config.image=="object"&&(t=this._config.image.media_content_id||"");else{let l=(e=this._config)==null?void 0:e.image_entity;if(l&&this._hass){let d=(i=this._hass.states)==null?void 0:i[l];if(d)if(((r=this._config)==null?void 0:r.camera_view)==="live"&&l.startsWith("camera.")){let m=`/api/camera_proxy_stream/${l}`;t=this._resolveUrl(m)||m}else t=((a=d.attributes)==null?void 0:a.entity_picture)||((n=d.attributes)==null?void 0:n.image)||(typeof d.state=="string"?d.state:"")}}return this._resolveUrl(t)||t}_resolveUrl(t){if(!t||typeof t!="string")return"";let o=t.trim();return o.startsWith("/")&&this._hass&&typeof this._hass.hassUrl=="function"?this._hass.hassUrl(o):o}static _imageCacheKey(t){return"picture-overview-cadu-img-"+(t||"")}_getImageEntityCache(t){if(!t||typeof t!="string")return null;try{return localStorage.getItem(s._imageCacheKey(t))||null}catch(o){return null}}_saveImageEntityCache(t,o){if(!(!t||typeof t!="string"||!o))try{localStorage.setItem(s._imageCacheKey(t),String(o))}catch(e){}}_getPrimaryEntityId(){var o;let t=Array.isArray((o=this._config)==null?void 0:o.entities)?this._config.entities:[];return t.length>0?t[0].entity:null}_getOverlayEntityConfigs(){var e;let t=Array.isArray((e=this._config)==null?void 0:e.entities)?this._config.entities:[];if(t.length===0)return[];let o=t.filter(i=>(i==null?void 0:i.show_state)===!0);return o.length>0?o:t.length>0?[t[0]]:[]}_getEntityName(t){var e,i,r;if(t!=null&&t.name)return t.name;let o=(i=(e=this._hass)==null?void 0:e.states)==null?void 0:i[t.entity];return((r=o==null?void 0:o.attributes)==null?void 0:r.friendly_name)||t.entity}_createEntityIcon(t){var r,a;let o=t==null?void 0:t.icon,e=(a=(r=this._hass)==null?void 0:r.states)==null?void 0:a[t.entity];if(e){let n=document.createElement("ha-state-icon");if(n.hass=this._hass,n.stateObj=e,o&&o!=="")n.icon=o;else{let l=this._getEntityIconFromState(e);l&&(n.icon=l)}return n}let i=document.createElement("ha-icon");return i.icon=o&&o!==""?o:"mdi:checkbox-blank-circle-outline",i}_getEntityIconFromState(t){var i,r;if(!t)return"";let o=(i=t.attributes)==null?void 0:i.icon;return o||(((r=t.attributes)==null?void 0:r.device_class)==="temperature"?"mdi:thermometer":"")}_getEntityState(t,o=null){var l,d,m;let e=(d=(l=this._hass)==null?void 0:l.states)==null?void 0:d[t];if(!e)return"unavailable";let i=(m=e.attributes)==null?void 0:m.unit_of_measurement,r=Number.isFinite(o==null?void 0:o.decimals)?o.decimals:1,a=typeof e.state=="string"?e.state.replace(",","."):e.state,n=Number.parseFloat(a);if(Number.isFinite(n)){let h=n.toFixed(r);return i?`${h} ${i}`:h}return i?`${e.state} ${i}`:e.state}_handleAction(t,o){if(!t||t.action==="none")return;let e=t.action||"more-info";if(e==="more-info"){let i=t.entity||o;i&&this._fireEvent("hass-more-info",{entityId:i});return}if(e==="navigate"&&t.navigation_path){history.pushState(null,"",t.navigation_path),window.dispatchEvent(new Event("location-changed"));return}if(e==="url"&&t.url_path){window.location.href=t.url_path;return}if(e==="toggle"&&o&&this._hass){this._hass.callService("homeassistant","toggle",{entity_id:o});return}if(e==="call-service"&&t.service&&this._hass){let[i,r]=t.service.split(".");i&&r&&this._hass.callService(i,r,t.service_data||{})}}_fireEvent(t,o){this.dispatchEvent(new CustomEvent(t,{detail:o,bubbles:!0,composed:!0}))}};var L=class extends HTMLElement{constructor(){super(),this._updating=!1}setConfig(t){this._config=O(t||{}),this._rendered&&this._hass?this._syncFormData():!this._rendered&&this._hass&&this._render()}set hass(t){this._hass=t,this._hass&&(this._rendered&&!this._updating?this._syncFormData():!this._rendered&&this._config&&this._render())}_render(){if(!this._hass)return;if(this._rendered){this._form&&(this._form.hass=this._hass);return}this._rendered=!0,this.innerHTML="";let t=document.createElement("ha-form");t.hass=this._hass;let o=O(this._config||{});o=this._ensureEntitiesArray(o),t.schema=this._buildSchema(),t.computeLabel=e=>e.label||e.name,t.data=o,t.addEventListener("value-changed",e=>{JSON.stringify(this._config)!==JSON.stringify(e.detail.value)&&(this._config=e.detail.value,this._debounce&&clearTimeout(this._debounce),this._debounce=setTimeout(()=>{this._dispatchConfigChanged(this._config)},500))}),this.appendChild(t),this._form=t}_syncFormData(){}_ensureEntitiesArray(t){if(!t||typeof t!="object"||Array.isArray(t.entities))return t;if(t.entities&&typeof t.entities=="object"){let o=Object.keys(t.entities).filter(e=>/^\d+$/.test(e)).sort((e,i)=>Number(e)-Number(i)).map(e=>t.entities[e]);return{...t,entities:o}}return{...t,entities:[]}}_buildSchema(){return[{name:"title",label:"Titulo",selector:{text:{}}},{name:"title_icon",label:"Icone do titulo (opcional)",selector:{icon:{}}},{name:"title_secondary",label:"Titulo secundario (ao lado, menor)",selector:{text:{}}},{name:"subtitle",label:"Subtitulo (opcional, aceita template jinja)",selector:{template:{}}},{name:"image",label:"Imagem (url/local)",selector:{text:{}}},{name:"image_media_content_id",label:"Imagem (media_content_id)",selector:{text:{}}},{name:"image_entity",label:"Entidade de imagem (opcional)",selector:{entity:{}}},{name:"aspect_ratio",label:"Aspect ratio (ex: 1.5 ou 16:9)",selector:{text:{}}},{name:"fit_mode",label:"Fit mode",selector:{select:{options:[{label:"Cover",value:"cover"},{label:"Contain",value:"contain"}]}}},{name:"camera_view",label:"Camera view",selector:{select:{options:[{label:"Auto",value:"auto"},{label:"Live",value:"live"}]}}},{name:"tap_action",label:"Tap action do card",selector:{ui_action:{}}},{name:"entities",label:"Entidades",selector:{object:{multiple:!0,label_field:"entity",fields:{entity:{label:"Entidade",required:!0,selector:{entity:{}}},name:{label:"Nome (opcional)",selector:{text:{}}},icon:{label:"Icone (opcional)",selector:{icon:{}}},show_state:{label:"Mostrar estado",selector:{boolean:{}}},show_condition:{label:"Condicao (template Jinja: true exibe, false oculta)",selector:{template:{}}},position:{label:"Posicao do overlay",selector:{select:{options:[{label:"Inferior",value:"bottom"},{label:"Superior direita",value:"top"}]}}},decimals:{label:"Casas decimais (padrao 1)",selector:{number:{min:0,max:4,step:1}}},background_color:{label:"Cor de fundo",selector:{color_rgb:{}}},background_color_opacity:{label:"Opacidade do fundo (%) \u2014 0 transparente, 100 opaco",selector:{number:{min:0,max:100,step:5,unit_of_measurement:"%"}}},border_width:{label:"Borda (px) \u2014 0 sem borda, 0.1 a 2",selector:{number:{min:0,max:2,step:.1,unit_of_measurement:"px"}}},border_color:{label:"Cor da borda (opcional)",selector:{color_rgb:{}}},text_color:{label:"Cor do texto (opcional)",selector:{color_rgb:{}}},tap_action:{label:"Tap action da entidade (opcional)",selector:{ui_action:{}}}}}}}]}_dispatchConfigChanged(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};customElements.get("picture-overview-cadu")||customElements.define("picture-overview-cadu",S);customElements.get("picture-overview-cadu-editor")||customElements.define("picture-overview-cadu-editor",L);S.getConfigElement=function(){return document.createElement("picture-overview-cadu-editor")};S.getStubConfig=function(){return{title:"Picture Overview",aspect_ratio:"1.5",fit_mode:"cover",entities:[]}};window.customCards=window.customCards||[];window.customCards.push({type:"picture-overview-cadu",name:"Picture Overview Cadu",description:"Imagem com entities e tap_action estilo picture-glance."});
